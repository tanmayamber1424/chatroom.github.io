...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal">Chatspot.com</h1>
    <p class="lead font-weight-normal">Chat With Your Friends Without Any Worry Using Our Free Chat Service Platform!</p>
    
<form action="claim.php" method="post">
<div class="container">

Chatspot.com<input row="1" type="text" name="room" id="mytext" placeholder="Enter Your Room Name"> 
